  ...
  implements Serializable
{
  ...
  public Music(String Name, String Autor, String Album, String data, Long tempo, String direitos, String comentario, String path) {
    this.Name = Name;
    this.Autor = Autor;
    this.Album = Album;
    this.data = data;
  ...
  {
    return "Musica{Name=" + Name + ", Autor=" + Autor + ", Album=" + Album + ", data=" + data + ", tempo=" + tempo + ", direitos=" + direitos + ", comentario=" + comentario + '}';
  }
